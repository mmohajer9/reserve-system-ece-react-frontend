"""
Django settings for reserve_system_ece project.
...
SECRET_KEY = '4k*=s5q5n^8exe(x2sk)(9%9y61^@6d=3*zo%1m@!ws=ayn_gx'
...
ROOT_URLCONF = 'reserve_system_ece.urls'
...
WSGI_APPLICATION = 'reserve_system_ece.wsgi.application'
